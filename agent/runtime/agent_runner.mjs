...
export async function runAgent({ agentName, inputArtifactPaths = [], task }) {
  ...
  await writeFile(outputPath, `${JSON.stringify({ agentName, task, inputArtifactPaths, result }, null, 2)}\n`, "utf8");
